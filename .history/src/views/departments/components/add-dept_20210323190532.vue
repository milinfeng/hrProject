  ...
  <el-dialog title="新增部门" :visible="showDialog">
    ...
    <el-form :model="formData" :rules="rules" label-width="120px">
      ...
      <el-form-item label="部门负责人" prop="manager">
        <el-select v-model="fromData.manager" style="width:80%" placeholder="请选择" />
      </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        manager: [{ required: true, message: '部门责任人不能为空', trigger: 'blur' },
          { min: 1, max: 50, message: '编码长度为1-50个字符', trigger: 'blur' }],
        introduce: [{ required: true, message: '部门编码不能为空', trigger: 'blur' },
          { min: 1, max: 300, message: '部门长度为1-30个字符', trigger: 'blur' }]
      } // 校验规则
    }
  },
  computed: {
